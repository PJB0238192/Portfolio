...
grep "/bin/bash" /etc/passwd | awk 'BEGIN {
    ...
    print "|__________|________|_________|______|_______| ";

}

{
    
    printf("| \033[33m%-8s\033[0m | \033[35m%-6s\033[0m | \033[35m%-7s\033[0m | \033[35m%-12s\033[0m | \033[35m%-24s\033[0m|\n", $1, $3, $4, $6, $7);
    
}

END {

    print("_____________test for line positions______________________________________________________________________________________________________");
